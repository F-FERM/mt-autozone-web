    ...
    <div className="flex flex-col gap-[6px]">
      ...
      >
        {value ? (
          ...
          <Loader2 className="h-[18px] w-[18px] animate-spin text-[#E40000]" />
        ) : (
          <UploadCloud className="h-[18px] w-[18px] text-[#E40000]" />
        )}
      </div>
      <Input
        value={value}
        ...
        className={`h-[34px] rounded-[8px] border-[#E4E4E4] bg-white text-[11px] focus-visible:ring-[#E40000]/30 ${
          hasChanged ? "border-2 border-[#E40000] bg-[#FFF9F4]" : ""
        }`}
      />
    </div>
